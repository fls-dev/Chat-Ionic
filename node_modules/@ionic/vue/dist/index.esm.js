...
import { defineCustomElement as defineCustomElement$6 } from '@ionic/core/components/ion-breadcrumb.js';
import { defineCustomElement as defineCustomElement$7 } from '@ionic/core/components/ion-breadcrumbs.js';
import { defineCustomElement as defineCustomElement$8 } from '@ionic/core/components/ion-button.js';
import { defineCustomElement as defineCustomElement$9 } from '@ionic/core/components/ion-buttons.js';
import { defineCustomElement as defineCustomElement$a } from '@ionic/core/components/ion-card.js';
import { defineCustomElement as defineCustomElement$b } from '@ionic/core/components/ion-card-content.js';
import { defineCustomElement as defineCustomElement$c } from '@ionic/core/components/ion-card-header.js';
import { defineCustomElement as defineCustomElement$d } from '@ionic/core/components/ion-card-subtitle.js';
import { defineCustomElement as defineCustomElement$e } from '@ionic/core/components/ion-card-title.js';
import { defineCustomElement as defineCustomElement$f } from '@ionic/core/components/ion-checkbox.js';
import { defineCustomElement as defineCustomElement$g } from '@ionic/core/components/ion-chip.js';
import { defineCustomElement as defineCustomElement$h } from '@ionic/core/components/ion-col.js';
import { defineCustomElement as defineCustomElement$i } from '@ionic/core/components/ion-content.js';
import { defineCustomElement as defineCustomElement$j } from '@ionic/core/components/ion-datetime.js';
...
import { IonNav as IonNav$1 } from '@ionic/core/components/ion-nav.js';
...
import { IonBackButton as IonBackButton$1 } from '@ionic/core/components/ion-back-button.js';
import { IonIcon as IonIcon$1 } from 'ionicons/components/ion-icon.js';
import { IonRouterOutlet as IonRouterOutlet$1 } from '@ionic/core/components/ion-router-outlet.js';
import { routeLocationKey, useRoute, matchedRouteKey } from 'vue-router';
import { IonTabButton as IonTabButton$1 } from '@ionic/core/components/ion-tab-button.js';
import { IonTabBar as IonTabBar$1 } from '@ionic/core/components/ion-tab-bar.js';
import { IonApp as IonApp$1 } from '@ionic/core/components/ion-app.js';
...
import { defineCustomElement as defineCustomElement$1a } from '@ionic/core/components/ion-picker.js';
...
/* eslint-disable */
const IonAccordion = /*@__PURE__*/ defineContainer('ion-accordion', defineCustomElement$1, [
    'value',
    'disabled',
    'readonly',
    'toggleIcon',
...
const IonAccordionGroup = /*@__PURE__*/ defineContainer('ion-accordion-group', defineCustomElement$2, [
    'animated',
    'multiple',
    'value',
    'disabled',
...
const IonAvatar = /*@__PURE__*/ defineContainer('ion-avatar', defineCustomElement$3);
const IonBackdrop = /*@__PURE__*/ defineContainer('ion-backdrop', defineCustomElement$4, [
    'visible',
    'tappable',
    'stopPropagation',
    'ionBackdropTap'
]);
const IonBadge = /*@__PURE__*/ defineContainer('ion-badge', defineCustomElement$5, [
    'color'
]);
const IonBreadcrumb = /*@__PURE__*/ defineContainer('ion-breadcrumb', defineCustomElement$6, [
    'collapsed',
    'last',
...
const IonBreadcrumbs = /*@__PURE__*/ defineContainer('ion-breadcrumbs', defineCustomElement$7, [
    'color',
    'maxItems',
    'itemsBeforeCollapse',
    'itemsAfterCollapse',
...
const IonButton = /*@__PURE__*/ defineContainer('ion-button', defineCustomElement$8, [
    'color',
    'buttonType',
    'disabled',
    'expand',
...
const IonButtons = /*@__PURE__*/ defineContainer('ion-buttons', defineCustomElement$9, [
    'collapse'
]);
const IonCard = /*@__PURE__*/ defineContainer('ion-card', defineCustomElement$a, [
    'color',
    'button',
    'type',
    'disabled',
...
const IonCardContent = /*@__PURE__*/ defineContainer('ion-card-content', defineCustomElement$b);
const IonCardHeader = /*@__PURE__*/ defineContainer('ion-card-header', defineCustomElement$c, [
    'color',
    'translucent'
]);
const IonCardSubtitle = /*@__PURE__*/ defineContainer('ion-card-subtitle', defineCustomElement$d, [
    'color'
]);
const IonCardTitle = /*@__PURE__*/ defineContainer('ion-card-title', defineCustomElement$e, [
    'color'
]);
const IonCheckbox = /*@__PURE__*/ defineContainer('ion-checkbox', defineCustomElement$f, [
    'color',
    'name',
    'checked',
    'indeterminate',
...
const IonChip = /*@__PURE__*/ defineContainer('ion-chip', defineCustomElement$g, [
    'color',
    'outline',
    'disabled'
]);
const IonCol = /*@__PURE__*/ defineContainer('ion-col', defineCustomElement$h, [
    'offset',
    'offsetXs',
    'offsetSm',
    'offsetMd',
...
const IonContent = /*@__PURE__*/ defineContainer('ion-content', defineCustomElement$i, [
    'color',
    'fullscreen',
    'forceOverscroll',
    'scrollX',
...
const IonDatetime = /*@__PURE__*/ defineContainer('ion-datetime', defineCustomElement$j, [
    'color',
    'name',
    'disabled',
    'readonly',
...
const IonBackButton = /*@__PURE__*/ defineComponent((_, { attrs, slots }) => {
    defineCustomElement('ion-back-button', IonBackButton$1);
...
const IonRouterOutlet = /*@__PURE__*/ defineComponent({
    ...
    setup() {
        defineCustomElement('ion-router-outlet', IonRouterOutlet$1);
...
const IonTabButton = /*@__PURE__*/ defineComponent({
    ...
    setup(props, { slots }) {
        defineCustomElement('ion-tab-button', IonTabButton$1);
        const ionRouter = inject('navManager');
        const onClick = (ev) => {
            if (ev.cancelable) {
                ev.preventDefault();
...
const IonTabBar = defineComponent({
    ...
    setup(_, { slots }) {
        defineCustomElement('ion-tab-bar', IonTabBar$1);
        return () => {
...
const IonApp = /*@__PURE__*/ defineComponent((_, { attrs, slots }) => {
    defineCustomElement('ion-app', IonApp$1);
    return () => {
...
const IonNav = /*@__PURE__*/ defineComponent(() => {
    defineCustomElement('ion-nav', IonNav$1);
    ...
    const createInlineComponent = () => {
        return defineComponent((props, { slots }) => {
            ...
            return () => {
                ...
                return h(name, Object.assign(Object.assign({}, restOfProps), { ref: elementRef }), (isOpen.value) ? slots : undefined);
            };
        });
    };
...
const IonActionSheet = /*@__PURE__*/ defineOverlayContainer('ion-action-sheet', defineCustomElement$17, ['animated', 'backdropDismiss', 'buttons', 'cssClass', 'enterAnimation', 'header', 'htmlAttributes', 'keyboardClose', 'leaveAnimation', 'mode', 'subHeader', 'translucent'], actionSheetController$1);
const IonAlert = /*@__PURE__*/ defineOverlayContainer('ion-alert', defineCustomElement$18, ['animated', 'backdropDismiss', 'buttons', 'cssClass', 'enterAnimation', 'header', 'htmlAttributes', 'inputs', 'keyboardClose', 'leaveAnimation', 'message', 'mode', 'subHeader', 'translucent'], alertController$1);
const IonLoading = /*@__PURE__*/ defineOverlayContainer('ion-loading', defineCustomElement$19, ['animated', 'backdropDismiss', 'cssClass', 'duration', 'enterAnimation', 'htmlAttributes', 'keyboardClose', 'leaveAnimation', 'message', 'mode', 'showBackdrop', 'spinner', 'translucent'], loadingController$1);
const IonPicker = /*@__PURE__*/ defineOverlayContainer('ion-picker', defineCustomElement$1a, ['animated', 'backdropDismiss', 'buttons', 'columns', 'cssClass', 'duration', 'enterAnimation', 'htmlAttributes', 'keyboardClose', 'leaveAnimation', 'mode', 'showBackdrop'], pickerController$1);
const IonToast = /*@__PURE__*/ defineOverlayContainer('ion-toast', defineCustomElement$1b, ['animated', 'buttons', 'color', 'cssClass', 'duration', 'enterAnimation', 'header', 'htmlAttributes', 'icon', 'keyboardClose', 'leaveAnimation', 'message', 'mode', 'position', 'translucent'], toastController$1);
const IonModal = /*@__PURE__*/ defineOverlayContainer('ion-modal', defineCustomElement$1c, ['animated', 'backdropBreakpoint', 'backdropDismiss', 'breakpoints', 'canDismiss', 'enterAnimation', 'handle', 'htmlAttributes', 'initialBreakpoint', 'isOpen', 'keyboardClose', 'leaveAnimation', 'mode', 'presentingElement', 'showBackdrop', 'swipeToClose', 'trigger']);
const IonPopover = /*@__PURE__*/ defineOverlayContainer('ion-popover', defineCustomElement$1d, ['alignment', 'animated', 'arrow', 'backdropDismiss', 'component', 'componentProps', 'dismissOnSelect', 'enterAnimation', 'event', 'htmlAttributes', 'isOpen', 'keyboardClose', 'leaveAnimation', 'mode', 'reference', 'showBackdrop', 'side', 'size', 'translucent', 'trigger', 'triggerAction']);
...
const modalController = /*@__PURE__*/ createController(defineCustomElement$1c, modalController$1, true);
const popoverController = /*@__PURE__*/ createController(defineCustomElement$1d, popoverController$1, true);
const alertController = /*@__PURE__*/ createController(defineCustomElement$18, alertController$1);
const actionSheetController = /*@__PURE__*/ createController(defineCustomElement$17, actionSheetController$1);
const loadingController = /*@__PURE__*/ createController(defineCustomElement$19, loadingController$1);
const pickerController = /*@__PURE__*/ createController(defineCustomElement$1a, pickerController$1);
const toastController = /*@__PURE__*/ createController(defineCustomElement$1b, toastController$1);
