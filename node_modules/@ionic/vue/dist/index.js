...
const IonBackButton = /*@__PURE__*/ vue.defineComponent((_, { attrs, slots }) => {
    defineCustomElement('ion-back-button', ionBackButton_js.IonBackButton);
    defineCustomElement('ion-icon', ionIcon_js.IonIcon);
...
const IonRouterOutlet = /*@__PURE__*/ vue.defineComponent({
    ...
    setup() {
        defineCustomElement('ion-router-outlet', ionRouterOutlet_js.IonRouterOutlet);
...
const IonTabButton = /*@__PURE__*/ vue.defineComponent({
    ...
    setup(props, { slots }) {
        defineCustomElement('ion-tab-button', ionTabButton_js.IonTabButton);
        const ionRouter = vue.inject('navManager');
        const onClick = (ev) => {
            if (ev.cancelable) {
                ev.preventDefault();
...
const IonTabBar = vue.defineComponent({
    ...
    setup(_, { slots }) {
        defineCustomElement('ion-tab-bar', ionTabBar_js.IonTabBar);
        return () => {
...
const IonApp = /*@__PURE__*/ vue.defineComponent((_, { attrs, slots }) => {
    defineCustomElement('ion-app', ionApp_js.IonApp);
    return () => {
...
const IonNav = /*@__PURE__*/ vue.defineComponent(() => {
    defineCustomElement('ion-nav', ionNav_js.IonNav);
    ...
    const createInlineComponent = () => {
        return vue.defineComponent((props, { slots }) => {
            ...
            return () => {
                ...
                return vue.h(name, Object.assign(Object.assign({}, restOfProps), { ref: elementRef }), (isOpen.value) ? slots : undefined);
            };
        });
    };
